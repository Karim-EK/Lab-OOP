...
final class TestLambdaUtilities {
    ...
    void testFill() {
        ...
        assertEquals(map.get("p1").intValue(), 1);  // NOPMD suppressed as it is a false positive
        assertEquals(map.get("p2").intValue(), 2);  // NOPMD suppressed as it is a false positive
        assertEquals(map.get("p3").intValue(), 3);  // NOPMD suppressed as it is a false positive
