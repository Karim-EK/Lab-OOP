...
public final class UseOrderedWarehouse {
    ...
    public static void main(final String[] args) {
        ...
        //Ho dovuto cambiare il tipo da Product a ComparableProduct
        final ComparableProduct p1 = new ComparableProduct("Apple", 100);
        final ComparableProduct p2 = new ComparableProduct("Banana", 30);
        final ComparableProduct p3 = new ComparableProduct("Watermelon", 10);
        final Warehouse<ComparableProduct> warehouse = new OrderedWarehouse();
